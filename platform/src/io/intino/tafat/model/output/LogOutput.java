...
public class LogOutput {
	public static void init(io.intino.tafat.model.LogOutput self) {
	...
	public static void process(io.intino.tafat.model.LogOutput self) {
		if (self.checkStep()) {
	...
	public static boolean checkStep(io.intino.tafat.model.LogOutput self) {
		if (self.timeout() == 0) {
	...
	private static List<Object> collectValues(io.intino.tafat.model.LogOutput self) {
		List<Object> result = new ArrayList<>();
		for (io.intino.tafat.model.LogOutput.Line line : self.lineList()) result.add(line.value());
		return result;
	}
}
