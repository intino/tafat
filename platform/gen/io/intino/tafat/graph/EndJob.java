...
public class EndJob extends io.intino.tafat.graph.JobAction implements io.intino.tara.magritte.tags.Feature, io.intino.tara.magritte.tags.Terminal {


	public EndJob(io.intino.tara.magritte.Node node) {
		super(node);
	}
