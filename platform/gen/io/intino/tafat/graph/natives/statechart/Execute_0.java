...
/**StateChart#/Users/oroncal/workspace/tafat/platform/src/io/intino/tafat/graph/ModelingMechanisms.tara#37#1**/
public class Execute_0 implements io.intino.tafat.graph.functions.Execute, io.intino.tara.magritte.Function {
	...
	public void execute(int step) {
		io.intino.tafat.graph.ModelingMechanisms.updateStateChart(self, step);
	}
