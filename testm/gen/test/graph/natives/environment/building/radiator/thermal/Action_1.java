...
/**Environment.Building.Radiator.Thermal.Implementation.ConditionalAction#/Users/oroncal/workspace/tafat/testm/src/test/SystemDynamic.tara#12#53**/
public class Action_1 implements io.intino.tafat.graph.functions.Action, io.intino.tara.magritte.Function {
	...
	@Override
	public void execute() {
		test.SystemDynamic.stopHeating(self);
	}
