...
/**Router.Electrical.Implementation.StateChart.Transition.Condition#/Users/oroncal/workspace/tafat/testm/src/test/RouterStateChart.tara#15#42**/
public class Check_1 implements io.intino.tafat.graph.functions.CheckTransition, io.intino.tara.magritte.Function {
	...
	public boolean check(int advancedTime) {
		return test.RouterStateChart.checkIsOff(self, advancedTime);
	}
